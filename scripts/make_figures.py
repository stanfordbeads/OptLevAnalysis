...
fig,ax = pl.alpha_limit(aggdat.agg_dict,sensor='qpd')
fig.savefig(fig_path+'limit_qpd.png')
fig,ax = pl.alpha_limit(aggdat.agg_dict,sensor='pspd')
fig.savefig(fig_path+'limit_pspd.png')
fig,ax = pl.limit_vs_integration(aggdat.agg_dict,sensor='qpd')
fig.savefig(fig_path+'integ_qpd.png')
fig,ax = pl.limit_vs_integration(aggdat.agg_dict,sensor='pspd')
