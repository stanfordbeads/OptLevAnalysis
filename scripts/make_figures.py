...
fig,ax = pl.spectrogram(aggdat.agg_dict,descrip=descrip,sensor='pspd',axis_ind=0,which='roi')
fig.savefig(fig_path+'spectrogram_pspd_x_roi.png')
fig,ax = pl.spectrogram(aggdat.agg_dict,descrip=descrip,sensor='pspd',axis_ind=0,which='full')
fig.savefig(fig_path+'spectrogram_pspd_x_full.png')
fig,ax = pl.spectrogram(aggdat.agg_dict,descrip=descrip,sensor='pspd',axis_ind=0,which='rayleigh')
...
fig,ax = pl.spectrogram(aggdat.agg_dict,descrip=descrip,sensor='pspd',axis_ind=1,which='roi')
fig.savefig(fig_path+'spectrogram_pspd_y_roi.png')
fig,ax = pl.spectrogram(aggdat.agg_dict,descrip=descrip,sensor='pspd',axis_ind=1,which='full')
fig.savefig(fig_path+'spectrogram_pspd_y_full.png')
fig,ax = pl.spectrogram(aggdat.agg_dict,descrip=descrip,sensor='pspd',axis_ind=1,which='rayleigh')
...
fig,ax = pl.time_evolution(aggdat.agg_dict,descrip=descrip,sensor='pspd',axis_ind=0)
fig.savefig(fig_path+'time_ev_pspd_x.png')
fig,ax = pl.time_evolution(aggdat.agg_dict,descrip=descrip,sensor='pspd',axis_ind=1)
...
fig,ax = pl.polar_plots(aggdat.agg_dict,descrip=descrip,axis_ind=0,sensor='pspd')
fig.savefig(fig_path+'polar_pspd_x.png')
fig,ax = pl.polar_plots(aggdat.agg_dict,descrip=descrip,axis_ind=1,sensor='pspd')
...
fig,ax = pl.polar_plots(aggdat.agg_dict,descrip=descrip,axis_ind=0,sensor='pspd',unwrap=True)
fig.savefig(fig_path+'unwrapped_pspd_x.png')
fig,ax = pl.polar_plots(aggdat.agg_dict,descrip=descrip,axis_ind=1,sensor='pspd',unwrap=True)
...
fig,ax = pl.mles_vs_time(aggdat.agg_dict,descrip=descrip,sensor='pspd',axis_ind=0)
fig.savefig(fig_path+'mles_pspd_x.png')
fig,ax = pl.mles_vs_time(aggdat.agg_dict,descrip=descrip,sensor='pspd',axis_ind=1)
...
fig,ax = pl.alpha_limit(aggdat.agg_dict,descrip=descrip,sensor='pspd')
fig.savefig(fig_path+'limit_pspd.png')
fig,ax = pl.limit_vs_integration(aggdat.agg_dict,descrip=descrip,sensor='qpd')
fig.savefig(fig_path+'integ_qpd.png')
fig,ax = pl.limit_vs_integration(aggdat.agg_dict,descrip=descrip,sensor='pspd')
fig.savefig(fig_path+'integ_pspd.png')
plt.close('all')
